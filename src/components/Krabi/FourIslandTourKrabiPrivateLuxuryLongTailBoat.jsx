...
const FourIslandTourKrabiPrivateLuxuryLongTailBoat = () => {
    ...
    const handleAddToCart = () => {
        ...
        const cartItem = {
            title: "4 Island Tour from Krabi by Private Luxury Long Tail Boat",
            date: selectedDate,
            adults,
            children,
            totalPrice,
    ...
    useEffect(() => {
        ...
        const groupPrice = 6000; // Price per group of 5 people
    ...
    return (
        <div className="Thailand-Places">
                    ...
                    <div className="success-content">
                        ...
                        <div className="success-text">
                            ...
                            <p className="success-details">
                                <strong>Title:</strong>4 Island Tour from Krabi by Private Luxury Long Tail Boatt<br />
            ...
            <h3>4 Island Tour from Krabi by Private Luxury Long Tail Boat</h3>
            <div className="image-with-name">
                ...
                <div className="sticky-container">
                    ...
                    <p className="price"> 1-5 Persons 6,000 THB</p>
  ...
  <h4>Description</h4>
  <div>
    <h2>4 Island Tour from Krabi by Private Luxury Longtail Boat</h2>
    <p>
      Enjoy an exclusive private longtail boat tour to Krabi’s stunning four islands. Begin your journey at Railay Beach and Phra Nang Cave, famous for their breathtaking limestone cliffs and revered holy site. Explore the amazing sea nature of Thap Island, Kai Island, and Mo Island—part of "Unseen Thailand." Visit Poda Island and Tangming Island for a delicious beachside lunch before sightseeing, swimming, and snorkeling among colorful coral and marine life.
    </p>

    <h3>Pricing</h3>
    <ul>
      <li><strong>1-5 Persons:</strong> 6000 Baht (Private Tour)</li>
    </ul>
    ...
    <p>
      This private tour allows you to explore Krabi’s breathtaking islands at your own pace, offering the perfect blend of relaxation, adventure, and stunning scenery. Don't forget to bring sunscreen, a towel, and a camera to capture the beautiful views.
    </p>
    <h3>Child Policy</h3>
    <p>
...
export default FourIslandTourKrabiPrivateLuxuryLongTailBoat;
