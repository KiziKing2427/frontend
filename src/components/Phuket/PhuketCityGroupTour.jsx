...
const PhuketCityGroupTour = () => {
    ...
    useEffect(() => {
        const adultPrice = 800; // New price for adults
        ...
        <div className="Thailand-Places">
                    ...
                    <div className="success-content">
                        ...
                        <div className="success-text">
                            ...
                            <p className="success-details">
                                <strong>Title:</strong> Phuket City Group Tour<br />
            ...
            <div className="image-with-name">
                ...
                <div className="sticky-container">
                    ...
                    <p className="price">Adult 800 THB, Child 800 THB</p>
  ...
  <div>
    <h2>Phuket City Group Tour</h2>
    <p>
        Explore the beauty and cultural richness of Phuket on this guided group tour. Begin your adventure with a convenient hotel pickup, and set off to discover renowned landmarks such as the majestic Big Buddha statue and the sacred Wat Chalong temple. Gain fascinating insights from your knowledgeable local guide as you explore Phuket's picturesque beaches, uncovering the island's hidden treasures.
    </p>
    <p>
...
<h3>Price</h3>
<ul>
    <li>Adult: <strong>800 THB per person</strong></li>
    <li>Child: <strong>800 THB per person</strong></li>
</ul>
...
export default PhuketCityGroupTour;
