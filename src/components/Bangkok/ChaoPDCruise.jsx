...
const ChaoPDCruise = () => {
    ...
    const handleCalculatePrice = () => {
        const pricePerPerson = 1400; // Price per person in Baht
    ...
    const handlePayNow = () => {
     ...
     if (!selectedDate || adults === 0) {
         ...
         const sourceParam = encodeURIComponent('ChaoPDCruise'); // Unique identifier for the source page
        ...
        <div className="Thailand-Places">
            ...
            <div className="image-with-name">
                <div className="image-container">
                    <img src={logo21} alt="Place 21" />
                </div>
                <div className="price-frame">
                    <p className="price">Price: 1,400.00 Baht</p> <div>&nbsp;</div>
