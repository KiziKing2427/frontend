...
const DmkHotelTransfers  = () => {
    ...
    const [selectedVehicle, setSelectedVehicle] = useState(''); // Default vehicle type
...
>
  Add More Product
            ...
            <h1>Private Transfer from DMK Airport to Bangkok Hotels</h1>
            ...
            <div className="description">
                ...
                <p>Enjoy easy transfers between Don Muang airport and your chosen Thailand destination. Let a professional chauffeur help carry your bags and whisk you to your destination safely.</p>
                <ul>
                    <li>Easy transfer from Bangkok Don Mueang Airport to the city area</li>
                    <li>Experience easy and efficient Bangkok Don Mueang Airport transfers to your chosen Thailand destination in an air conditioned vehicle</li>
                    <li>English speaking driver</li>
                    <li>Enjoy a convenient pick up service from your hotel/airport by a professional chauffeur who'll carry your luggage</li>
                    <li>Choose between the comfortable car or van to suit the size of your traveling party.</li>
                </ul>
                ...
                <ul>
                    <li>Food</li>
                    <li>Tollways Fee (subject to change depending on Thai Government Policy)</li>
                    <li>Tips and gratuities (optional)</li>
                    <li>Other personal expenses</li>
                    <li>Adding Child seats (200 Baht per seat)</li>
                    <li>Additional waiting charge (300 Baht per hour)</li>
                    <li>Additional child seats (THB 200 per seat)</li>
                    <li>Pick up outside service area (optional)</li>
                    <li>Gratuities</li>
                    <li>Additional waiting time (THB 300 per hour)</li>
                    <li>Meal or food not included</li>
                </ul>
            </div>
        </div>
        </div>
...
export default DmkHotelTransfers;
