      ...
      <div className="success-content">
        ...
        <div className="success-text">
          ...
          <p className="success-details">
            <strong>Title:</strong> Bangkok hotel to Pattaya hotel transportation<br />
...
>
  Add More Product
            ...
            <h1>Bangkok hotel to Pattaya hotel transportation</h1>
            ...
            <h4>What makes this transport unique?</h4>
                <p>
                    Book this private transfer to Pattaya for a relaxed journey with our experienced driver.
                    Easy transfer from Hotel in Bangkok to the Pattaya city.
                </p>
                <p>
                    You will experience easy and efficient transfers in an air-conditioned vehicle, with an English-speaking driver, and
                    convenient pick-up service from your hotel to hotel by a professional chauffeur who'll carry your luggage.
                </p>
                <p>
                    Choose between the comfortable car or van to suit the size of your traveling party.
                </p>
...
export default BangkokPattayaTransfers;
