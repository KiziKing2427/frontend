...
const AmphawaFloatingMarketBangkok = () => {
    ...
    const handleCalculatePrice = () => {
        const pricePerPerson = 1500; // Price per person in Baht
    ...
    const handlePayNow = () => {
     ...
     if (!selectedDate || adults === 0) {
         ...
         const sourceParam = encodeURIComponent('AmphawaFloatingMarketBangkok'); // Unique identifier for the source page
    ...
    return (
        <div className="Thailand-Places">
            <h3>Amphawa Flaoting market bangkok</h3>
            <div className="image-with-name">
                <div className="image-container">
                    <img src={logo32} alt="Place 32" />
                </div>
                <div className="price-frame">
                    <p className="price">Price: 1,500.00 Baht</p> <div>&nbsp;</div>
