...
const ThreeTempleAndGPTB = () => {
    ...
    const handleCalculatePrice = () => {
        const pricePerPerson = 3000; // Price per person in Baht
    ...
    const handlePayNow = () => {
        ...
        if (!selectedDate || adults === 0) {
            ...
            const sourceParam = encodeURIComponent('ThreeTempleAndGPTB'); // Unique identifier for the source page
    ...
    return (
        <div className="Thailand-Places">
            <h3> Three temple and Grand palace tour Bangkok</h3>
            <div className="image-with-name">
                <div className="image-container">
                    <img src={logo22} alt="Place 22" />
                </div>
                <div className="price-frame">
                    <p className="price">Price: 3,000.00 Baht</p> <div>&nbsp;</div>
