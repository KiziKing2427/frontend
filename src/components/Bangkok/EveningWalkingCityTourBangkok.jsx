...
const EveningWalkingCityTourBangkok = () => {
    ...
    const handleCalculatePrice = () => {
        const pricePerPerson = 800; // Price per person in Baht
    ...
    const handlePayNow = () => {
     ...
     if (!selectedDate || adults === 0) {
         ...
         const sourceParam = encodeURIComponent('EveningWalkingCityTourBangkok'); // Unique identifier for the source page
    ...
    return (
        <div className="Thailand-Places">
            <h3>Evening walking city tour bangkok</h3>
            <div className="image-with-name">
                <div className="image-container">
                    <img src={logo35} alt="Place 35" />
                </div>
                <div className="price-frame">
                    <p className="price">Price: 800.00 Baht</p> <div>&nbsp;</div>
