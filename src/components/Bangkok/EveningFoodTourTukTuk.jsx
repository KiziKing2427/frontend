...
const EveningFoodTourTukTuk = () => {
    ...
    const handleCalculatePrice = () => {
        const pricePerPerson = 2000; // Price per person in Baht
    ...
    const handlePayNow = () => {
     ...
     if (!selectedDate || adults === 0) {
         ...
         const sourceParam = encodeURIComponent('EveningFoodTourTukTuk'); // Unique identifier for the source page
        ...
        <div className="Thailand-Places">
            ...
            <div className="image-with-name">
                <div className="image-container">
                    <img src={logo34} alt="Place 34" />
                </div>
                <div className="price-frame">
                    <p className="price">Price: 2,000.00 Baht</p> <div>&nbsp;</div>
