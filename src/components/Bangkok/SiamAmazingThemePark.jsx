...
const SiamAmazingThemePark = () => {
    ...
    const handlePayNow = () => {
     ...
     if (!selectedDate || adults === 0) {
         ...
         const sourceParam = encodeURIComponent('SiamAmazingThemePark'); // Unique identifier for the source page
    ...
    return (
        <div className="Thailand-Places">
            <h3>Siam Amazing Theme Park</h3>
            <div className="image-with-name">
                <div className="image-container">
                    <img src={logo30} alt="Place 30" />
                </div>
