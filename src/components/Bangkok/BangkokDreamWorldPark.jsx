...
const BangkokDreamWorldPark = () => {
    ...
    const handleCalculatePrice = () => {
        const pricePerPerson = 1200; // Price per person in Baht
    ...
    const handlePayNow = () => {
     ...
     if (!selectedDate || adults === 0) {
         ...
         const sourceParam = encodeURIComponent('BangkokDreamWorldPark'); // Unique identifier for the source page
        ...
        <div className="Thailand-Places">
            ...
            <div className="image-with-name">
                <div className="image-container">
                    <img src={logo33} alt="Place 13" />
                </div>
                <div className="price-frame">
                    <p className="price">Price: 1,200.00 Baht</p> <div>&nbsp;</div>
