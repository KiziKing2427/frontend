...
const BangkokMSW = () => {
    ...
    if (!selectedDate || adults === 0) {
        ...
        const dateParam = encodeURIComponent(selectedDate); // Include date
        const sourceParam = encodeURIComponent('BangkokMSW'); // Unique identifier for the source page
