...
const BangkokCityShoppingT = () => {
    ...
    const handleCalculatePrice = () => {
        const pricePerPerson = 1800; // Price per person in Baht
    ...
    const handlePayNow = () => {
     ...
     if (!selectedDate || adults === 0) {
         ...
         const sourceParam = encodeURIComponent('BangkokCityShoppingT'); // Unique identifier for the source page
    ...
    return (
        <div className="Thailand-Places">
            <h3>Bangkok city and Shopping Tour</h3>
            <div className="image-with-name">
                <div className="image-container">
                    <img src={logo26} alt="Place 26" />
                </div>
                <div className="price-frame">
                    <p className="price">Price: 1,800.00 Baht</p> <div>&nbsp;</div>
