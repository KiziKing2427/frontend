...
const SafariWorldAndMPB = () => {
    ...
    const handlePayNow = () => {
     ...
     if (!selectedDate || adults === 0) {
         ...
         const sourceParam = encodeURIComponent('SafariWorldAndMPB'); // Unique identifier for the source page
    ...
    return (
        <div className="Thailand-Places">
            <h3>Safari world and Marine Park Bangkok</h3>
            <div className="image-with-name">
                <div className="image-container">
                    <img src={logo27} alt="Place 27" />
                </div>
