...
const DamnoenSadukAndMRMB = () => {
    ...
    const handlePayNow = () => {
     ...
     if (!selectedDate || adults === 0) {
         ...
         const sourceParam = encodeURIComponent('DamnoenSadukAndMRMB'); // Unique identifier for the source page
    ...
    return (
        <div className="Thailand-Places">
            <h3><h4> Damnoen Saduk and Maeklong Railway Market <br/>Bangkok</h4></h3>
            <div className="image-with-name">
                <div className="image-container">
                    <img src={logo29} alt="Place 29" />
                </div>
