...
const BangkokCityTT = () => {
    ...
    const handleCalculatePrice = () => {
        const pricePerPerson = 900; // Price per person in Baht
    ...
    const handlePayNow = () => {
     ...
     if (!selectedDate || adults === 0) {
         ...
         const sourceParam = encodeURIComponent('BangkokCityTT'); // Unique identifier for the source page
    ...
    return (
        <div className="Thailand-Places">
            <h3> Bangkok city and temple tour</h3>
            <div className="image-with-name">
                <div className="image-container">
                    <img src={logo25} alt="Place 25" />
                </div>
                <div className="price-frame">
                    <p className="price">Price: 900.00 Baht</p> <div>&nbsp;</div>
