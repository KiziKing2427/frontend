...
const TheSanctuaryOfTruthEntranceTicket = () => {
    ...
    useEffect(() => {
        const adultPrice = 499; // New price for adults
        const childPrice = 249;  // New price for children
        ...
        <div className="Thailand-Places">
            ...
            <div className="image-with-name">
                ...
                <div className="sticky-container">
                    ...
                    <p className="price">Adult 499 THB  Child 249 THB</p>
  ...
  <h4>Description</h4>
  <div>
    <h2>The Sanctuary of Truth - Entrance Ticket [Morning Session : 8:00-18:00]
    </h2>

    <h3>Pricing</h3>
    <ul>
      <li><strong>Adult:</strong> 499 Baht</li>
      <li><strong>Child:</strong> 249 Baht</li>
    </ul>
    ...
    <h3>Thai Classical Dance Performances</h3>
    <p>Experience the elegance of Thai culture through traditional dance performances.</p>
    <ul>
      <li><strong>Show Times:</strong></li>
      <li>11:30 AM</li>
      <li>1:30 PM</li>
      <li>3:30 PM</li>
    </ul>
    ...
    <p>
      Witness the grandeur of Thailand’s finest wooden architecture and immerse yourself in the artistry and culture at The Sanctuary of Truth.
    </p>
    <h3>Child Policy</h3>
    <p>
...
export default  TheSanctuaryOfTruthEntranceTicket;
